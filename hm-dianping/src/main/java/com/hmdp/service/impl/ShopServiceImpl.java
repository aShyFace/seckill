...
public class ShopServiceImpl extends ServiceImpl<ShopMapper, Shop> implements IShopService {
  ...
  public Result queryShopByType(Integer typeId, Integer current, Double x, Double y) {
    ...
    //String key = SHOP_GEO_TYPE_KEY + typeId;
    //GeoResults<RedisGeoCommands.GeoLocation<String>> results = redisCache.getRedisTemplate().opsForGeo() // GEOSEARCH key BYLONLAT x y BYRADIUS 10 WITHDISTANCE
    //  .search(
    //    key,
